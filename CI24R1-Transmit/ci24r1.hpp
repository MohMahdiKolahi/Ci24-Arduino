...
#ifndef __CI24R1_HPP__
#define __CI24R1_HPP__
...
//////////////////
#define CI24R1_DATA_OUT()        pinMode(CI24R1_MOSI, OUTPUT)
#define CI24R1_DATA_IN()         pinMode(CI24R1_MOSI, INPUT_PULLUP)
#define CI24R1_DATA_LOW()        digitalWrite(CI24R1_MOSI, LOW)
#define CI24R1_DATA_HIGH()       digitalWrite(CI24R1_MOSI, HIGH)
#define CI24R1_DATA_READ()       digitalRead(CI24R1_MOSI)

#define CI24R1_CLK_LOW()         digitalWrite(CI24R1_SCK, LOW)
#define CI24R1_CLK_HIGH()        digitalWrite(CI24R1_SCK, HIGH)

#define CI24R1_NSS_LOW()         digitalWrite(CI24R1_CSN, LOW)
#define CI24R1_NSS_HIGH()        digitalWrite(CI24R1_CSN, HIGH)
